...
The framework is scale-invariant: principal angles depend on the dimensionless ratio $\gamma/J_{\max}$ (dephasing to coupling), not absolute energy. Any $d$-level system — photosynthetic antenna, neural oscillator assembly, molecular complex — can be placed on the same axis.
...
| **Cortical gamma** (neural) | 10 | $99 \to 9$ | ~$8 \times 10^{12}$ | $90.00°$ | Deep classical — 12 orders past the boundary |

All three systems show the same transition geometry at $\gamma/J_{\max} \sim O(1)$, confirming scale invariance. The framework converts "is it quantum?" from a binary question into a continuous geometric bound: *how many orders of magnitude of environmental shielding would be needed for quantum effects to become geometrically distinguishable?*
...
| See cross-scale comparison | §6.4 + Table in Appendix C |
...
**[Information Geometry of the Quantum-Classical Transition: From Photosynthetic Excitons to Neural Oscillations](decoherence_biology.pdf)**
...
@article{todd2026information,
  author  = {Todd, Ian},
  title   = {Information Geometry of the Quantum-Classical Transition:
             From Photosynthetic Excitons to Neural Oscillations},
