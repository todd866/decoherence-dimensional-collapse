...
Theorem~\ref{thm:global-orthogonality} settles the qualitative question: for $d \geq 3$, any coherence breaks orthogonality. The perturbative result (Theorem~\ref{thm:qudit-angles}) complements this by quantifying \emph{how much} the subspaces mix as a function of coherence magnitude and dephasing rate. Figure~\ref{fig:qudit-angles} illustrates both results numerically.
